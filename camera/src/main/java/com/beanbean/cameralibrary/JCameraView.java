...
import com.beanbean.cameralibrary.state.CameraMachine;
...
import com.beanbean.cameralibrary.view.CameraView;
    ...
    private void setFlashRes() {
        switch (type_flash) {
            ...
            case TYPE_FLASH_ON:
                ...
                CameraInterface.getInstance().setFlashMode(Camera.Parameters.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
