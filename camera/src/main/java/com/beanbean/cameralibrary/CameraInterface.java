package com.beanbean.cameralibrary;
...
import com.beanbean.cameralibrary.listener.ErrorListener;
import com.beanbean.cameralibrary.util.AngleUtil;
import com.beanbean.cameralibrary.util.CameraParamUtil;
import com.beanbean.cameralibrary.util.CheckPermission;
import com.beanbean.cameralibrary.util.DeviceUtil;
import com.beanbean.cameralibrary.util.FileUtil;
import com.beanbean.cameralibrary.util.LogUtil;
import com.beanbean.cameralibrary.util.ScreenUtils;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setFlashMode(String flashMode) {
       ...
       // params.setFlashMode(flashMode);
        doSetTorch(params,flashMode);
        mCamera.setParameters(params);
    }

    private void doSetTorch(Camera.Parameters parameters, String newSetting) {
        String flashMode = null;
        if (newSetting.equals(Camera.Parameters.FLASH_MODE_ON)) {
            flashMode = findSettableValue(parameters.getSupportedFlashModes(),
                    Camera.Parameters.FLASH_MODE_TORCH,
                    Camera.Parameters.FLASH_MODE_ON);
        } else if (newSetting.equals(Camera.Parameters.FLASH_MODE_OFF)) {
            flashMode = findSettableValue(parameters.getSupportedFlashModes(),
                    Camera.Parameters.FLASH_MODE_OFF);
        } else if (newSetting.equals(Camera.Parameters.FLASH_MODE_AUTO)) {
            flashMode = findSettableValue(parameters.getSupportedFlashModes(),
                    Camera.Parameters.FLASH_MODE_TORCH,
