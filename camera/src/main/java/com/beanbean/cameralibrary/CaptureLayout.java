...
import com.beanbean.cameralibrary.listener.CaptureListener;
import com.beanbean.cameralibrary.listener.ClickListener;
import com.beanbean.cameralibrary.listener.ReturnListener;
import com.beanbean.cameralibrary.listener.TypeListener;

import static com.beanbean.cameralibrary.JCameraView.BUTTON_STATE_BOTH;
import static com.beanbean.cameralibrary.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static com.beanbean.cameralibrary.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
//                resetCaptureLayout();
    ...
    public void setButtonFeatures(int state) {
        ...
        if (state == BUTTON_STATE_BOTH){
            setTipText(getResources().getString(R.string.cameralibrary_photo_video));
        } else if (state == BUTTON_STATE_ONLY_CAPTURE){
            setTipText(getResources().getString(R.string.cameralibrary_only_photo));
        }else if (state == BUTTON_STATE_ONLY_RECORDER){
            setTipText(getResources().getString(R.string.cameralibrary_only_video));
        }
    }
